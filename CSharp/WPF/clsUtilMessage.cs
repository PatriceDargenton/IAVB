...
namespace Utils
{
    ...
    public static class clsMessageUtils
    {
        ...
        {
            // WinForm : MessageBox.Show(sTxt, AppUtils.AppTitle, MessageBoxButtons.OK, MessageBoxIcon.Error);
            // WPF :
            MessageBox.Show(sTxt, clsAppUtils.AppTitle, MessageBoxButton.OK , MessageBoxImage.Error);
        }
