...
Private m_lst As List(Of String)
Public Sub New(lst As List(Of String))
    m_lst = lst
End Sub
...
Public Sub InitAssertionsExemples()

    'AjouterExemple(m_oIAVB.sCmdEff & " ' Effacer toute la base")
    'AjouterExemple(m_oIAVB.sCmdEffDern & " ' Effacer la denière assertion")
    'AjouterExemple(m_oIAVB.sCmdEffPrem & " ' Effacer l'assertion n°1")
    ...
    'AjouterExemple(m_oIAVB.sCmdTag & " ' Mettre en sourdine (autre poss.: masquer l'agent)")
